      ...
      subcommands: {
        ...
        'profiler': {
          ...
          subcommands: {
            ...
            'labels': { description: 'Behavioral and entity labels', options: { address: { type: 'string', required: true }, chain: { type: 'string', default: 'ethereum' }, limit: { type: 'number' } }, returns: ['label', 'label_type', 'label_subtype'] },
